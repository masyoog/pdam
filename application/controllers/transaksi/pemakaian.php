...
class Pemakaian extends MY_Controller {
    ...
    private $_CFG;
    private $_TBL_PRIMARY = "pemakaian a";
    ...
    function __construct() {
        ...
        $menu = new Datagridcolumn();
        $menu->set_FIELD_DB("a.meter_awal");
        $menu->set_FIELD_TYPE($menu->get_NUM_TYPE());
        $menu->set_FORM_ID("meter_awal");
        $menu->set_SIZE(12);
        $this->_CFG->add_column("Meter Awal", $menu);
        
        $menu = new Datagridcolumn();
        $menu->set_FIELD_DB("a.meter_akhir");
        $menu->set_FIELD_TYPE($menu->get_NUM_TYPE());
        $menu->set_FORM_ID("meter_akhir");
        $menu->set_SIZE(12);
        $this->_CFG->add_column("Meter Akhir", $menu);
        
        $menu = new Datagridcolumn();
        $menu->set_FIELD_DB("a.jumlah_meter");
        $menu->set_FIELD_TYPE($menu->get_NUM_TYPE());
        $menu->set_FORM_ID("jumlah_meter");
        $menu->set_SIZE(12);
        $this->_CFG->add_column("Jumlah Meter", $menu);
