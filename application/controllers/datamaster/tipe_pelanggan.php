 ...
 */
class Tipe_pelanggan extends MY_Controller {
    
    private $_CFG;
    private $_TBL_PRIMARY = "mt_tipe_pelanggan a";
    private $_TBL_PRIMARY_PK = "a.id";    
    private $_ORDER = array("a.kode ASC");
    ...
    function __construct() {
        ...
        $this->_CFG->add_column("Kode", $menu);
        ...
        $menu = new Datagridcolumn();
        $menu->set_FIELD_DB("a.deskripsi");
        $menu->set_SIZE(256);
        $menu->set_FORM_ID("deskripsi");
        $this->_CFG->add_column("Deskripsi", $menu);
        ...
        /*
        $this->_CFG->set_grid_group_button(
            array(
                "Tarif Air" => array("action" => "openBox('URL', '80')", "method"=>"".base_url("datamaster/tarif/index").""),
                "Biaya Administrasi" => array("method"=>"".base_url("datamaster/tarif/index").""),
                "Denda" => array("method"=>"".base_url("datamaster/tarif/index").""),
                "Biaya Instalasi" => array("method"=>"".base_url("datamaster/tarif/index").""),
                "Biaya Open Blokir" => array("method"=>"".base_url("datamaster/tarif/index")."")
            )
        );
        */
        
//        $this->_CFG->add_grid_button(
//                "Set Tarif Non Air" , array(
//                    "method" => base_url("datamaster/tarif_non_air/index"),
//                    "style" => "fa-cogs",
