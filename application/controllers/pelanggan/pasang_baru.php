 ...
 */
class Pasang_baru extends MY_Controller {
    ...
    private $_TBL_JOIN = array("mt_tipe_pelanggan b"=>"b.id=a.id_tipe_pelanggan");
    private $_INDEX_PAGE;
    ...
    function __construct() {
        ...
        $menu->set_SIZE(32);
        $menu->set_FORM_ID("tipe_pelanggan");
    ...
    function form($mode="add", $key = "") {
        ...
        $tipePelanggan->set_FIELD_DB_ALIAS("tipe_pelanggan");
        ...
        $tipePelanggan->set_FORM_ID("tipe_pelanggan");
